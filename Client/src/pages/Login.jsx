...
return (
  <div className="min-h-screen bg-white flex flex-col items-center px-4">
    ...
    <div className="w-full max-w-3xl text-center mt-16 mb-10">
      <h1 className="text-4xl font-bold text-gray-900">Log In To Continue</h1>
      <p className="text-gray-600 mt-2">
        Access your Dot-In account to continue
      </p>
    </div>
    ...
    <div className="w-full max-w-lg bg-white border border-gray-200 rounded-2xl shadow-sm p-10">
      ...
      <div className="text-center mb-8">
        <div className="text-2xl font-semibold text-gray-900">Dot-In</div>
        <div className="text-sm text-gray-500 mt-1">Log in to continue</div>
      </div>
